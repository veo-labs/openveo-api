 ...
 * @return {Array} The list of values for the given property
 */
module.exports.getPropertyFromArray = function(property, list, recursiveProperty) {
  var self = this;
  var values = [];
  ...
  list.forEach(function(item) {
    ...
    if (recursiveProperty && item[recursiveProperty])
      values = values.concat(self.getPropertyFromArray(property, item[recursiveProperty], recursiveProperty));
  });
