 ...
 * @param {module:util~validateFilesCallback} callback The function to call when done
 */
module.exports.validateFiles = function(filesToAnalyze, validationDescription, callback) {
  ...
  var getAsyncFunction = function(id, filePath) {
    return function(callback) {
      fileSystem.getFileType(filePath, function(error, fileType) {
 ...
 * @param {*} [startValue] The value of the searched property to start collecting values from
...
/**
 * @callback module:util~validateFilesCallback
 * @param {(Error|null)} error The error if an error occurred, null otherwise
 * @param {Object|undefined} files Files with keys as the files identifiers and values as Objects containing validation
 *     information: isValid and [type]{@link module:fileSystem.FILE_TYPES}
 */
