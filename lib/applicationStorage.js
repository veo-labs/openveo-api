 ...
 *
 * @method getSessionSecret
 * @return {String} The session secret
 */
module.exports.getSessionSecret = function() {
 ...
 *
 * It can be set only once.
 * @param {String} secret The sessionSecret
 * @throws {Error} An error if session secret is already set
 */
module.exports.setSessionSecret = function(secret) {
  if (sessionSecret === undefined)
    sessionSecret = secret;
  else
    throw new Error('Session secret can only be set onece');
};
