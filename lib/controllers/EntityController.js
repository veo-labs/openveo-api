 ...
 * @extends Controller
 * @constructor
 * @param {Function} ModelConstructor An entity model constructor
 * @param {Function} ProviderConstructor An entity provider constructor
 * @throws {TypeError} An error if constructors are not as expected
 */
function EntityController(ModelConstructor, ProviderConstructor) {
  EntityController.super_.call(this);

  if (!(ModelConstructor.prototype instanceof Model) || !(ProviderConstructor.prototype instanceof Provider))
    throw new TypeError('EntityController requires an EntityModel constructor and an EntityProvider constructor');

  Object.defineProperties(this, {

    /**
     * Model's constructor associated to the entity.
     *
     * @property Model
     * @type Function
     * @final
     */
    Model: {value: ModelConstructor},

    /**
     * Provider's constructor associated to the entity.
     *
     * @property Provider
     * @type Function
     * @final
     */
    Provider: {value: ProviderConstructor}
 ...
 * @param {Request} request ExpressJS HTTP Request
 * @param {Object} request.params Request's parameters
 * @param {String} request.params.id The entity id to remove
 * @param {Response} response ExpressJS HTTP Response
 * @param {Function} next Function to defer execution to the next registered middleware
 */
...
EntityController.prototype.getModel = function() {
  return new this.Model(new this.Provider(api.getCoreApi().getDatabase()));
};
