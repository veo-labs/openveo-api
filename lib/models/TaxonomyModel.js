 ...
 *       api.TaxonomyModel.call(this, user, new CustomProvider(api.applicationStorage.getDatabase()));
 *
 *     }
 *
 ...
 */
function TaxonomyModel(user) {
  EntityModel.call(this, user, new TaxonomyProvider(applicationStorage.getDatabase()));
}
